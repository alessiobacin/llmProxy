...
function createApp(options = {}) {
  ...
  function buildCodexModelEntry(id, displayName, description, ownedBy) {
    return {
      slug: id,
  ...
  app.get("/v1/models/:modelId", (req, res) => {
    ...
    if (isProxyModelLabel(modelId)) return res.json(proxyAutoModel);
