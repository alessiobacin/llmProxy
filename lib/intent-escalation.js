...
class IntentTracker {
  ...
  track(intent, currentModel, availableProviders) {
    ...
    // Keep returning the escalationModel on every call while intent is active
...
module.exports = { IntentTracker, extractKeywordsFingerprint, extractLastUserMessage, buildIntentPrompt, parseIntentFromResponse, CLASSIFY_SYSTEM_PROMPT };
