...
// Billing attribution requires the full organizational chain.
const REQUIRED_BILLING_FIELDS = ["master_company", "tenant_id", "client_id", "project_id"];
...
function validateHierarchyContextForBilling(hierarchyContext) {
  ...
  const missingFields = REQUIRED_BILLING_FIELDS.filter((field) => {
