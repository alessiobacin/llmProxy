...
function loadRuntimeEnv(options = {}) {
  ...
  return {
    ...
    DBLAYER_URL: String(env.DBLAYER_URL || serviceEnv.DBLAYER_URL || parsed.DBLAYER_URL || `http://localhost:${portPrefix}001`),
    EVENTBUS_URL: String(env.EVENTBUS_URL || serviceEnv.EVENTBUS_URL || parsed.EVENTBUS_URL || `http://localhost:${portPrefix}048`),
  };
}
